	...
	public ArrayList<poleVO> pole_selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				vo = new poleVO(getPole_code, getMac_code, getPole_height, getPole_addr, getPole_date, getpole_high, getpole_down, getPole_com, getTransformer_yn, getEmp_id, getPole_level, getPole_office);
