...
<link rel="stylesheet" href="css/polecss.css">
</head>
<body>
		<center>
		<div id="modal3">
			<form action="updatepole" method="post" class="pole_form">
				<table class="pole_tb_body" cellpadding="2"
					...
					<tr height="25">
						<td class="wid5"><img src="./images/check2.png" width="25px"
							; height="25px";></td>
						<td class="wid6">담당 사업소</td>
						<td><select name="pole_office"
							style="margin: 0 0 0 -6%; width: 150px; height: 30px">
								<option>선택하세요</option>
